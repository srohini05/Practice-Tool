...
export function SegmentedControl(props: SegmentedControlProps) {
    ...
    return segments.length > 0 ? (
        <>
            {/* Track */}
            <Stack {...stackProps} name={"track"} background={trackColor} height={height} width={width}>
                    ...
                    return (
                        <React.Fragment key={index}>
                            <Frame
                                ...
                                width={direction === "horizontal" ? width / segments.length : width}
                                // Other props
                                radius={borderRadius}
                                // Style props
                                style={{
                            ...
                            >
                                <h3 style={{ ...segmentTextStyle, fontSize }}>{segment.text}</h3>
                            </Frame>
            ...
            {/* Sliding Segment */}
            {!disabled && slide && (
                <Stack {...stackProps} height={height - 4} width={width - 4} top={2} left={2}>
                    {allSegments.map((segment, index) => {
                        ...
                        return (
                            ...
                            >
                                <h3 style={{ ...segmentTextStyle, fontSize }}>{allSegments[selected].text}</h3>
                            </Stack>
                        )
                    })}
                </Stack>
