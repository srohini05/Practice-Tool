...
import { Frame, addPropertyControls, ControlType, useMotionValue, useTransform, transform, RenderTarget } from "framer"
...
export function Slider({
    ...
    if (RenderTarget.current() === RenderTarget.canvas) x.set(transform(value, [min, max], [0, width]))
    ...
    return (
        <Frame width="100%" height={track} center={true} overflow={"visible"} radius={100} backgroundColor={background}>
            <Frame width={fill} height={track} overflow={"visible"} radius={100} backgroundColor={fillColor} />
            <Frame
                size={knobSize}
                radius={200}
